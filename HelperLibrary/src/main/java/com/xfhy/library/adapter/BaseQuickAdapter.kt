...
@JvmOverloads constructor(@LayoutRes layoutResId: Int, data: MutableList<T>? = null) : RecyclerView.Adapter<K>() {
    ...
    @IntDef(ALPHAIN.toLong(), SCALEIN.toLong(), SLIDEIN_BOTTOM.toLong(), SLIDEIN_LEFT.toLong(), SLIDEIN_RIGHT.toLong(), SLIDEIN_TOP.toLong())
     ...
     * 方向
     */
    @IntDef(LinearLayout.HORIZONTAL.toLong(), LinearLayout.VERTICAL.toLong())
    @Retention(RetentionPolicy.SOURCE)
